...
class RestauranteNaoEncontradoExceptionTest {

    @Test
    @DisplayName("Deve criar exceção com mensagem correta")
    void deveCriarExcecaoComMensagemCorreta() {
        String mensagem = "Restaurante não encontrado com o ID informado";

        RestauranteNaoEncontradoException excecao = new RestauranteNaoEncontradoException(mensagem);
