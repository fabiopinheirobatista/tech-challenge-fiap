...
@Transactional
@ActiveProfiles("test")
public class ItensCardapioDeletarControllerIT {
    ...
    @Test
    void deveRetornar200_QuandoDeletarComSucesso() throws Exception {
        mockMvc.perform(delete("/api/itens-cardapio/deletar/" + idItem))
                .andExpect(status().isOk())
                .andExpect(content().string("Item deletado com sucesso"));
    }

    @Test
    void deveRetornar404_QuandoDeletarItemInexistente() throws Exception {
        mockMvc.perform(delete("/api/itens-cardapio/deletar/999"))
